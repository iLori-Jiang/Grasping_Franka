...
def load_cali_matrix(file_path):
    ...
    cam_T_base_R, cam_T_base_t = cv2.calibrateHandEye(EE_T_base_mats_R, EE_T_base_mats_t, cam_T_marker_mats_R,
                                                      cam_T_marker_mats_t)
    ...
    for i in range(cube_size):
        for j in range(cube_size):
            for k in range(cube_size):
                ...
                print("move target: ",
                      [arm_target_x, arm_target_y, arm_target_z, arm_target_roll, arm_target_pitch, arm_target_yaw])
                ...
                cam_T_marker_R, cam_T_marker_t, visualize_img = ar_marker.get_mat_cam_T_marker(color_frame, maker_size,
